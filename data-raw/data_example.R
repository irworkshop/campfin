vt_contribs <- tibble::tribble(
  ...
  "01", "Bill Miller",as.Date("2019-09-02"), 10, "Lisa", "Miller", "4 Sheffield Sq Rd", "Sheffield", "VT", "05866",
  ...
  "04", "Jake White", as.Date("2019-09-05"), 100, "Josh", "Jones", "sugarhouse road", "E Corinth", "VT", "5076",
  "05", "Bill Miller",as.Date("2019-09-02"), 10, "Lisa", "Miller", "4 Sheffield Sq Rd", "Sheffield", "VT", "05866",
  "06", "Jake White", as.Date("2019-09-06"), 1000, "Bob", "Taylor", "55 thisplace ave", "young america", "mn", "55555",
  "07", "Jake White", as.Date("2019-09-07"), -600, "Alex", "Johnson", "11 Liberty ST", "Bristol, VT", "VT", "05443-1211",
