...
#'
#' @description This function tests whether all the files in a directory have a modification date
#' equal to the system date. Useful when repeatedly running code with a lengthy download stage.
#' Many state databases are updated daily, so new data can be helpful but not always neccesary.
#' Set this function in an `if` statement.
...
#' @return logical; whether _all_ files in the directory have a modification date equal to today.
...
#'
#' @description This function tests whether a single file has a modification date equal to the
#' system date. Useful when repeatedly running code with a lengthy download stage. Many state
#' databases are updated daily, so new data can be helpful but not always neccesary. Set this
