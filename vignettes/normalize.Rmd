...
We will first try to reach this threshhold by normalizing our data. This process
...
cities, but shouldn't be changed (some of these are contained in our currated
`extra_city` vector).
